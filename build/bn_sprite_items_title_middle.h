...
//
//	Time-stamp: 2023-08-06, 22:35:15
...
{
    constexpr inline sprite_item title_middle(sprite_shape_size(sprite_shape::SQUARE, sprite_size::NORMAL), 
            sprite_tiles_item(span<const tile>(title_middle_bn_gfxTiles, 48), bpp_mode::BPP_8, compression_type::NONE, 6), 
